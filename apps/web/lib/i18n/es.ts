...
export const es: typeof en = {
  ...
  dashboard: {
    ...
    scanStop: 'Detener',
    scanOnlyEtoro: 'Solo activos eToro',
    trade: 'Operar',
    tradeAmount: 'Monto (USD)',
    tradeAmountPlaceholder: 'ej. 100',
    orderSuccess: 'Orden enviada.',
  ...
  settings: {
    ...
    etoroSectionTitle: 'eToro (trading desde el escáner)',
    etoroSectionHint: 'Guarda tu API key y User key de eToro para filtrar el escáner por instrumentos eToro y abrir órdenes desde las recomendaciones. Las claves se guardan de forma segura.',
    etoroApiKey: 'eToro API key (x-api-key)',
    etoroApiKeyPlaceholder: 'Introduce tu API key de eToro',
    etoroUserKey: 'eToro User key (x-user-key)',
    etoroUserKeyPlaceholder: 'Introduce tu User key de eToro',
    etoroTradingAccount: 'Cuenta de trading',
    etoroDemo: 'Demo',
    etoroReal: 'Real',
    etoroRealWarning: 'Real usa dinero real. Cambia a Real solo cuando estés seguro.',
    etoroSaved: 'Ajustes de eToro guardados.',
  },
  alerts: {
    title: 'Alertas',
    rules: 'Reglas',
