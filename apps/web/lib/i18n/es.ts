...
export const es: typeof en = {
  ...
  dashboard: {
    ...
    scanMarketHint: 'Escanea acciones, ETFs, materias primas y cripto en todo el mercado para encontrar las mejores oportunidades de compra usando análisis de IA.',
