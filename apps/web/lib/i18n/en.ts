export const en = {
  ...
  dashboard: {
    ...
    scoreHistoryWhatItIs: 'Each bar is that week’s score: how many indicators were GREEN (0–8). It is not compared to another series; it shows the trend over time.',
    scoreHistoryHowToInterpret: 'Use it to see if conditions are improving (rising bars) or worsening (falling bars). More green indicators = healthier market context.',
