export const en = {
  ...
  dashboard: {
    ...
    myAssets: 'My Assets',
    myAssetsHint: 'Search and add assets (stocks, ETFs, commodities, crypto) to get AI recommendations based on the dashboard and current prices.',
    ...
    populateSuccess: 'Symbols loaded successfully.',
    assetSymbol: 'Symbol',
    assetType: 'Type',
    ...
    noAssetsHint: 'Add at least one asset above to generate AI recommendations.',
    configureLlmHint: 'Configure an LLM (OpenAI) in Settings to use recommendations.',
    entryPrice: 'Entry',
    exitPrice: 'Exit',
    ...
    scanMarketHint: 'Scan stocks, ETFs, commodities and crypto across the market to find the best buying opportunities using AI analysis.',
    ...
    scanStop: 'Stop',
    scanOnlyEtoro: 'Only eToro assets',
    trade: 'Trade',
    tradeAmount: 'Amount (USD)',
    tradeAmountPlaceholder: 'e.g. 100',
  ...
  settings: {
    ...
    llmApiKeyPlaceholderSaved: 'Enter a new key to replace the saved one',
    llmApiKeySaved: 'A key is already saved. Enter a new value only to replace it.',
    llmSaved: 'Settings saved.',
    save: 'Save',
    apiKeyRequired: 'API key is required.',
    signInRequired: 'You must be signed in to save settings.',
    etoroSectionTitle: 'eToro (trading from scanner)',
    etoroSectionHint: 'Store your eToro API key and User key to filter the scanner by eToro instruments and place orders from recommendations. Keys are stored securely.',
    etoroApiKey: 'eToro API key (x-api-key)',
    etoroApiKeyPlaceholder: 'Enter your eToro API key',
    etoroUserKey: 'eToro User key (x-user-key)',
    etoroUserKeyPlaceholder: 'Enter your eToro User key',
    etoroTradingAccount: 'Trading account',
    etoroDemo: 'Demo',
    etoroReal: 'Real',
    etoroRealWarning: 'Real uses real money. Only switch to Real when you are sure.',
    etoroSaved: 'eToro settings saved.',
  },
  alerts: {
    title: 'Alerts',
    rules: 'Rules',
    on: 'On',
    off: 'Off',
    noRules: 'No rules. Create one below.',
    ...
    conditionCrossBelow: 'Cross below threshold',
    conditionCrossAbove: 'Cross above threshold',
    conditionTrendChange: 'Trend change',
    conditionPersistence: 'Persistence (e.g. green status)',
    indicator: 'Indicator',
    threshold: 'Threshold',
    confirmations: 'Confirmations',
    enabled: 'Enabled',
    sendEmail: 'Send email when triggered',
    emailRecipientNote: 'Recipient is set by ALERT_EMAIL in Netlify.',
    save: 'Save',
    cancel: 'Cancel',
  },
